...
#define IMGVIEW_ZOOM_IN     (BUTTON_DPAD_DOWN)
#define IMGVIEW_ZOOM_OUT    (BUTTON_DPAD_UP)
#define IMGVIEW_UP        (BUTTON_DPAD_LEFT)
#define IMGVIEW_DOWN       (BUTTON_DPAD_RIGHT)
#define IMGVIEW_QUIT        (BUTTON_BACK | BUTTON_REL)
