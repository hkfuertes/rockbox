...
#define FLIPIT_SCROLLWHEEL
#define FLIPIT_LEFT         BUTTON_DPAD_LEFT
#define FLIPIT_RIGHT        BUTTON_DPAD_RIGHT
#define FLIPIT_UP           BUTTON_BACK
#define FLIPIT_DOWN         BUTTON_TOPLEFT
#define FLIPIT_NEXT         BUTTON_DPAD_DOWN
#define FLIPIT_PREV         BUTTON_DPAD_UP
#define FLIPIT_QUIT         (BUTTON_DPAD_CENTER | BUTTON_REPEAT)
#define FLIPIT_SHUFFLE      (BUTTON_DPAD_CENTER | BUTTON_DPAD_LEFT)
#define FLIPIT_SOLVE        (BUTTON_DPAD_CENTER | BUTTON_BACK)
#define FLIPIT_STEP_BY_STEP (BUTTON_DPAD_CENTER | BUTTON_DPAD_RIGHT)
#define FLIPIT_TOGGLE_PRE   BUTTON_DPAD_CENTER
#define FLIPIT_TOGGLE       (BUTTON_DPAD_CENTER | BUTTON_REL)
