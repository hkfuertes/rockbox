...
#define BTN_UP         BUTTON_BACK
#define BTN_DOWN       BUTTON_TOPLEFT
#define BTN_LEFT       BUTTON_DPAD_LEFT
#define BTN_RIGHT      BUTTON_DPAD_RIGHT
#define BTN_FIRE       BUTTON_DPAD_CENTER
#define BTN_PAUSE      (BUTTON_BACK | BUTTON_DPAD_CENTER)
