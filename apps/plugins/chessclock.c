...
#define CHC_QUIT BUTTON_TOPLEFT
#define CHC_STARTSTOP BUTTON_DPAD_CENTER
#define CHC_RESET BUTTON_DPAD_LEFT
#define CHC_MENU ACTION_STD_MENU
#define CHC_SETTINGS_INC BUTTON_DPAD_DOWN
#define CHC_SETTINGS_DEC BUTTON_DPAD_UP
#define CHC_SETTINGS_OK BUTTON_DPAD_CENTER
