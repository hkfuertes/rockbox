...
#define STOPWATCH_START_STOP BUTTON_DPAD_CENTER
#define STOPWATCH_RESET_TIMER BUTTON_DPAD_LEFT
#define STOPWATCH_LAP_TIMER BUTTON_DPAD_RIGHT
#define STOPWATCH_SCROLL_UP BUTTON_DPAD_DOWN
#define STOPWATCH_SCROLL_DOWN BUTTON_DPAD_UP
