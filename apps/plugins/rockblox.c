...
#define ROCKBLOX_OFF           (BUTTON_DPAD_CENTER | BUTTON_REPEAT)
#define ROCKBLOX_ROTATE_CCW    BUTTON_DPAD_UP
#define ROCKBLOX_ROTATE_CW     BUTTON_DPAD_DOWN
#define ROCKBLOX_LEFT          BUTTON_DPAD_LEFT
#define ROCKBLOX_RIGHT         BUTTON_DPAD_RIGHT
#define ROCKBLOX_DOWN          BUTTON_TOPLEFT
#define ROCKBLOX_RESTART       (BUTTON_DPAD_CENTER | BUTTON_BACK)
#define ROCKBLOX_DROP_PRE      BUTTON_DPAD_CENTER
#define ROCKBLOX_DROP          (BUTTON_DPAD_CENTER | BUTTON_REL)
