...
#define CUBE_QUIT_PRE      BUTTON_BACK
#define CUBE_QUIT          (BUTTON_BACK | BUTTON_REL)
#define CUBE_NEXT          BUTTON_DPAD_RIGHT
#define CUBE_PREV          BUTTON_DPAD_LEFT
#define CUBE_INC           BUTTON_DPAD_DOWN
#define CUBE_DEC           BUTTON_DPAD_UP
#define CUBE_MODE_PRE      BUTTON_BACK
#define CUBE_MODE          (BUTTON_BACK | BUTTON_REPEAT)
#define CUBE_PAUSE         BUTTON_TOPLEFT
#define CUBE_HIGHSPEED_PRE BUTTON_DPAD_CENTER
#define CUBE_HIGHSPEED     (BUTTON_DPAD_CENTER | BUTTON_REL)
